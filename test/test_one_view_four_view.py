...
def test_four_view_handling(qtbot, test_object, init_config):
    ...
    assert test_object.main_window.dicom_axial_view.pos().x(), test_object.main_window.dicom_axial_view.pos().y() == (
        0, 0)
    assert test_object.main_window.dicom_sagittal_view.pos().x(), test_object.main_window.dicom_sagittal_view.pos().y() == (
        0, 1)
    assert test_object.main_window.dicom_coronal_view.pos().x(), test_object.main_window.dicom_coronal_view.pos().y() == (
        1, 0)

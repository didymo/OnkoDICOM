...
def test_input_structure(selection_object) -> None:
    pass
...
def test_body_section_clicked(selection_object) -> None:
    pass

def test_parent_states(selection_object) -> None:
    pass

def test_child_states(selection_object) -> None:
    pass

def test_parent_section_changed(selection_object) -> None:
    pass

def test_specific_structure_changed(selection_object) -> None:
    pass

def test_setting_parent_states(selection_object) -> None:
    pass

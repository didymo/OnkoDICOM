...
class TestSuv2RoiGui:
    ...
    SUV2ROI GUI - using files from testdata directory
    """
...
def test_structures_convert_suv_to_roi_button_pressed(test_object):
    ...
    """
    # Set patient weight
    test_object.main_window.action_handler.suv2roi.patient_weight = 70000

    # Simulate 'Convert SUVs to ROIs' button being pressed
    test_object.main_window.action_handler.progress_window.start(
        test_object.main_window.action_handler.suv2roi.start_conversion)

...
class TestStructureTab:
    ...
    def __init__(self):
        ...
        self.dicom_view = self.main_window.dicom_view_axial
        self.new_polygons = {}
...
def test_structure_tab_check_checkboxes(test_object):
    ...
    for roi in test_object.rois:
        ...
        view_polygons = test_object.main_window.dicom_view_axial.patient_dict_container.get("dict_polygons")

        # Get the currently selected ROIs
        selected_rois = test_object.main_window.dicom_view_axial.patient_dict_container.get("selected_rois")
        selected_roi_names = []

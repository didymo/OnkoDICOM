...
def test_structure_tab_check_checkboxes(test_object):
    for roi in test_object.rois:
        ...
        view_polygons = test_object.main_window.dicom_view.patient_dict_container.get("dict_polygons")

        # Get the currently selected ROIs
        selected_rois = test_object.main_window.dicom_view.patient_dict_container.get("selected_rois")
        selected_roi_names = []

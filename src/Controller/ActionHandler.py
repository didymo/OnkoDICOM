...
class ActionHandler:
    ...
    def save_struct_handler(self):
        """
        If there are changes to the RTSTRUCT detected, save the changes to
        disk.
        """
    ...
    def windowing_handler(self, state, text):
        """
        Function triggered when a window is selected from the menu. :param
        state: Variable not used. Present to be able to use a lambda
        function. :param text: The name of the window selected.
        """

...
class Pyrad2PyradSROptions(QtWidgets.QWidget):
    ...
    def set_pyrad_sr_output_location(self, path, enable=True,
                                     change_if_modified=False):
        """
        Set the location for the resulting PyRad2PyRad-SR.dcm file.
        ----------
    ...
    def get_pyrad_sr_output_location(self):
        """
    ...
    def show_file_browser(self):
        ...
        # Update file path
        self.set_pyrad_sr_output_location(path, change_if_modified=True)

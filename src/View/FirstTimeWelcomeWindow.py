...
from PySide6.QtWidgets import QSizePolicy, QVBoxLayout, QHBoxLayout, \
    QPushButton, QWidget, QLineEdit, QMessageBox, QFileDialog
...
class UIFirstTimeWelcomeWindow(object):
    ...
    def setup_ui(self, first_time_welcome_window_instance):
        ...
        window_icon.addPixmap(QtGui.QPixmap(
            resource_path("res/images/icon.ico")),
        ...
        self.first_time_welcome_logo.setPixmap(QtGui.QPixmap(resource_path(
        ...
        # Create a label to prompt the user to enter the path to the default
        # directory
        ...
        self.first_time_welcome_choose_button.setCursor(QtGui.QCursor(
        ...
        self.save_dir_button.setCursor(QtGui.QCursor(
            QtCore.Qt.PointingHandCursor))
        ...
        # Create a widget to house all of the actions button for first-time
        # window
    ...
    def retranslate_ui(self, first_time_welcome_window_instance):
        ...
        self.first_time_welcome_message_label.setText(_translate(
            "FirstTimeWelcomeWindowInstance", "Welcome to OnkoDICOM!"))
        self.first_time_welcome_message_slogan.setText(_translate(
            "FirstTimeWelcomeWindowInstance", "OnkoDICOM - the solution for "
                                              "producing data for analysis "
                                              "from your oncology plans "
                                              "and scans."))
        self.first_time_welcome_default_dir_prompt.setText(_translate(
            "FirstTimeWelcomeWindowInstance", "Choose the path of the default "
                                              "directory containing all "
                                              "DICOM files:"))
        self.first_time_welcome_input_box.setPlaceholderText(_translate(
            "FirstTimeWelcomeWindowInstance", "Enter DICOM Files Path (For "
                                              "example, "
                                              "C:\path\\to\your\DICOM\Files)"))
        self.first_time_welcome_choose_button.setText(_translate(
            "FirstTimeWelcomeWindowInstance", "Choose"))
        self.save_dir_button.setText(_translate(
            "FirstTimeWelcomeWindowInstance", "Confirm"))
        self.skip_button.setText(_translate(
            "FirstTimeWelcomeWindowInstance", "Skip"))

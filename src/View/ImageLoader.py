...
class ImageLoader(QtCore.QObject):
    ...
    def __init__(self, dict_type, selected_files, existing_rtss_path, parent_window,
                 *args, **kwargs):
    ...
    def load(self, interrupt_flag, progress_callback):
        ...
        if self.dict_type == "fixed":
            patient_dict_container = PatientDictContainer()
        elif self.dict_type == "moving":
            patient_dict_container = MovingDictContainer()
        else:
            print("Comparison has gone wrong. Please try again.")

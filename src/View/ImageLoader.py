...
class ImageLoader(QtCore.QObject):
    ...
    def load(self, interrupt_flag, progress_callback):
        ...
        :param progress_callback: A signal that receives the current progress
        of the loading.
        ...
        patient_dict_container.set_initial_values(
            path, read_data_dict, file_names_dict)
        ...
        if 'rtss' in file_names_dict:
            ...
            if 'rtdose' in file_names_dict and self.calc_dvh:
                ...
                # multiprocessing on these platforms more expensive than
                # linear calculation. As such, multiprocessing is only
                # available on Linux until a better solution is found.
                ...
                if platform.system() in fork_safe_platforms:
                    ...
                    raw_dvh = ImageLoading.calc_dvhs(
                        dataset_rtss, dataset_rtdose, rois,

...
class MenuBar(object):
    ...
    def __init__(self, main_window):
        ...
        :param main_window:
         the window of the main page ( PatientDisplay for example )
        """
    ...
    def init_icons(self):
        ...
        self.iconOpen.addPixmap(QtGui.QPixmap(":/src/Icon/open_patient.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)

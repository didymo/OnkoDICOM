...
class PatientBar(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.patient_bar_icon.setPixmap(QtGui.QPixmap(resource_path(
            "res/images/btn-icons/patient.png")))
        ...
        self.patient_bar_name_info.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        self.patient_bar_name_info.resize(
            self.patient_bar_name_info.sizeHint().width(),
        ...
        self.patient_bar_name_info_label.setObjectName(
            "PatientBarNameInfoLabel")
        self.patient_bar_name_info_label.setText("Name:")
        self.patient_bar_name_info_label.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.Minimum)
        self.patient_bar_name_info_label.resize(
            self.patient_bar_name_info_label.sizeHint().width(),
            self.patient_bar_name_info_label.sizeHint().height())
        self.patient_bar_name_info_label.setProperty(
            "PatientBarClass", "label")
        ...
        self.patient_bar_id_info.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        self.patient_bar_id_info.resize(
            self.patient_bar_id_info.sizeHint().width(),
        ...
        self.patient_bar_id_info_label.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.Minimum)
        self.patient_bar_id_info_label.resize(
            self.patient_bar_id_info_label.sizeHint().width(),
        ...
        self.patient_bar_gender_info.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        self.patient_bar_gender_info.resize(
            self.patient_bar_gender_info.sizeHint().width(),
        ...
        self.patient_bar_gender_info_label.setObjectName(
            "PatientBarGenderInfoLabel")
        self.patient_bar_gender_info_label.setText("Gender:")
        self.patient_bar_gender_info_label.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.Minimum)
        self.patient_bar_gender_info_label.resize(
            self.patient_bar_gender_info_label.sizeHint().width(),
            self.patient_bar_gender_info_label.sizeHint().height())
        self.patient_bar_gender_info_label.setProperty(
            "PatientBarClass", "label")
        ...
        self.patient_bar_dob_info.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        self.patient_bar_dob_info.resize(
            self.patient_bar_dob_info.sizeHint().width(),
        ...
        self.patient_bar_dob_info_label.setSizePolicy(
            QSizePolicy.MinimumExpanding, QSizePolicy.Minimum)
        self.patient_bar_dob_info_label.resize(
            self.patient_bar_dob_info_label.sizeHint().width(),
            self.patient_bar_dob_info_label.sizeHint().height())
        self.patient_bar_dob_info_label.setProperty(
            "PatientBarClass", "label")
        # # Set layout

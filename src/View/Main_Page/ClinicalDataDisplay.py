...
class Ui_CD_Display(object):
    ...
    def setupUi(self, tabWindow):
        ...
        # self.tab2_clinicalData = QtWidgets.QWidget()
        # self.tab2_clinicalData.setFocusPolicy(QtCore.Qt.NoFocus)
    ...
    def retranslateUi(self):
        ...
        self.Brachy.setItemText(6, _translate(
            "MainWindow", "Neoadjuvant (Neo)"))
        self.Brachy.setItemText(7, _translate(
            "MainWindow", "Concurrent (Con)"))
    ...
    def set_layout(self):
        ...
        fixed_spacer = QtWidgets.QSpacerItem(10, 15, hPolicy=QtWidgets.QSizePolicy.Fixed,
                                             vPolicy=QtWidgets.QSizePolicy.Minimum)
        # Add all components into layout_content
        ...
        self.layout_content.addWidget(self.label_gender, 1, 0, 1, 2)
        self.layout_content.addWidget(self.gender, 1, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 1, 4)
        self.layout_content.addWidget(self.label_BP, 1, 5, 1, 2)
        self.layout_content.addWidget(self.line_BP, 1, 7, 1, 2)
        self.layout_content.addWidget(self.label_AD, 2, 0, 1, 2)
        self.layout_content.addWidget(self.age_at_diagnosis, 2, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 2, 4)
        self.layout_content.addWidget(self.label_Dx_year, 2, 5, 1, 2)
        self.layout_content.addWidget(self.line_Dx_Year, 2, 7, 1, 2)
        self.layout_content.addWidget(self.label_icd, 3, 0, 1, 2)
        self.layout_content.addWidget(self.line_icd, 3, 2, 1, 7)
        self.layout_content.addWidget(self.label_histology, 4, 0, 1, 2)
        self.layout_content.addWidget(self.line_histology, 4, 2, 1, 7)
        self.layout_content.addWidget(self.label_T_stage, 5, 0)
        self.layout_content.addWidget(self.T_stage, 5, 1)
        self.layout_content.addWidget(self.label_N_Stage, 5, 2)
        self.layout_content.addWidget(self.N_stage, 5, 3)
        self.layout_content.addWidget(self.label_M_Stage, 5, 4)
        self.layout_content.addWidget(self.M_stage, 5, 5)
        self.layout_content.addWidget(self.label_Overall_Stage, 5, 6)
        self.layout_content.addWidget(self.Overall_Stage, 5, 7)
        # self.layout_content.addItem(hspacer, 5, -1, 1)
        self.layout_content.addWidget(self.label_Tx_intent, 6, 0, 1, 2)
        self.layout_content.addWidget(self.Tx_intent, 6, 2, 1, 2)
        self.layout_content.addItem(hspacer, 6, -1, 1)
        self.layout_content.addWidget(self.label_Surgery, 7, 0, 1, 2)
        self.layout_content.addWidget(self.Surgery, 7, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 7, 4)
        self.layout_content.addWidget(self.label_Rad, 7, 5, 1, 2)
        self.layout_content.addWidget(self.Rad, 7, 7, 1, 2)
        self.layout_content.addWidget(self.label_Chemo, 8, 0, 1, 2)
        self.layout_content.addWidget(self.Chemo, 8, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 8, 4)
        self.layout_content.addWidget(self.label_Immuno, 8, 5, 1, 2)
        self.layout_content.addWidget(self.Immuno, 8, 7, 1, 2)
        self.layout_content.addWidget(self.label_Brachy, 9, 0, 1, 2)
        self.layout_content.addWidget(self.Brachy, 9, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 9, 4)
        self.layout_content.addWidget(self.label_Hormone, 9, 5, 1, 2)
        self.layout_content.addWidget(self.Hormone, 9, 7, 1, 2)
        self.layout_content.addWidget(self.label_SD, 10, 0, 1, 2)
        self.layout_content.addWidget(self.survival_duration, 10, 2, 1, 2)
        # self.layout_content.addItem(hspacer, 10, -1, 1)
        self.layout_content.addWidget(self.label_Death, 11, 0, 1, 2)
        self.layout_content.addWidget(self.Death, 11, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 11, 4)
        self.layout_content.addWidget(self.label_Cancer_death, 11, 5, 1, 2)
        self.layout_content.addWidget(self.Cancer_death, 11, 7, 1, 2)
        self.layout_content.addWidget(self.label_LCD, 12, 0, 1, 2)
        self.layout_content.addWidget(self.LC_duration, 12, 2)
        self.layout_content.addWidget(self.label_RCD, 12, 3, 1, 2)
        self.layout_content.addWidget(self.RC_duration, 12, 5)
        self.layout_content.addWidget(self.label_DCD, 12, 6, 1, 2)
        self.layout_content.addWidget(self.DC_duration, 12, 8)
        self.layout_content.addWidget(self.label_Local_control, 13, 0, 1, 2)
        self.layout_content.addWidget(self.Local_control, 13, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 13, 4)
        self.layout_content.addWidget(self.label_Dt_Local_failure, 13, 5, 1, 2)
        self.layout_content.addWidget(self.Dt_local_failure, 13, 7, 1, 2)
        self.layout_content.addWidget(self.label_Regional_control, 14, 0, 1, 2)
        self.layout_content.addWidget(self.Regional_Control, 14, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 14, 4)
        self.layout_content.addWidget(self.label_Dt_Regional_Failure, 14, 5, 1, 2)
        self.layout_content.addWidget(self.Dt_REgional_failure, 14, 7, 1, 2)
        self.layout_content.addWidget(self.label_Distant_Control, 15, 0, 1, 2)
        self.layout_content.addWidget(self.Distant_Control, 15, 2, 1, 2)
        self.layout_content.addItem(fixed_spacer, 15, 4)
        self.layout_content.addWidget(self.label_Dt_Distant_Failure, 15, 5, 1, 2)
        self.layout_content.addWidget(self.Dt_Distant_Failure, 15, 7, 1, 2)
        ...
        # return self.tab2_clinicalData
        # self.tabWindow.addTab(self.tab2_clinicalData, "Clinical Data")
    ...
    def create_note(self):
        ...
        # self.note.setStyleSheet("color: rgb(0,0,0) ")

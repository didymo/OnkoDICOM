...
class UIOpenPTCTPatientWindow(object):
    ...
    def setup_ui(self, open_pt_ct_window_instance):
        ...
        open_pt_ct_window_instance.setObjectName(
            "OpenPTCTWindowInstance")
        ...
        self.open_patient_window_exit_button.setProperty("QPushButtonClass",
                                                         "fail-button")
        ...
        # caller through slot
        open_pt_ct_window_instance.setStyleSheet(StyleSheetReader().get_stylesheet())
    ...
    def retranslate_ui(self, open_patient_window_instance):
        ...
        open_patient_window_instance.setWindowTitle(
            _translate("OpenPTCTWindowInstance",
                       "PT CT Fusion - Select Patient"))
    ...
    def check_selected_items(self):
        ...
        if 'RTSTRUCT' in selected_series_types:
            ...
            header = "Cannot proceed with an RTDOSE file"
            proceed = False
        elif 'RTPLAN' in selected_series_types:
            header = "Cannot proceed with an RTPLAN file"
            proceed = False
    ...
    def confirm_button_clicked(self):
        ...
        self.progress_window = PTCTProgressWindow(self)
...
class UIOpenPTCTPatientWindowDragAndDropEvent(QLineEdit):
    parent_window = None

    def __init__(self, UIOpenPTCTPatientWindowInstance):
        super(UIOpenPTCTPatientWindowDragAndDropEvent, self).__init__()
        self.parent_window = UIOpenPTCTPatientWindowInstance
    ...
    def dropEvent(self, event):
        ...
        if urls and urls[0].scheme() == 'file':
            ...
            UIOpenPTCTPatientWindow.scan_directory_for_patient(
                self.parent_window)
